...
public class SimpleWebServer {
	 ...
	 * be greater than 1024 and lest than 65535. The suggested port was 50505
	 * in the lesson. I figured it would be easy that way. 
	 */
	private final static int LISTENING_PORT = 50505;

	/**
	 * The server's root directory. I figured that the easiest would be a c:\temp.
	 * Easy to make - hard to forget.
	 */
	
	private final static String ROOT_DIRECTORY = "C:\\temp";
